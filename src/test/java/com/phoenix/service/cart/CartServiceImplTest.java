...
//        log.info("CartResponse ->{}", );
        ...
        assertThat(cartResponseDto.getCartItems().get(0).getQuantityAddedToCart()).isEqualTo(1);
        log.info("Cart response -> {}", cartResponseDto);
    }
    @Test
    ...
    void updateCartPriceTest() throws UserNotFoundException, ProductDoesNotExistException, BusinessLogicException {
        ...
        assertThat(cartResponseDto.getCartItems()).isNotNull();
        assertThat(cartResponseDto.getCartItems().size()).isEqualTo(1);
        assertThat(cartResponseDto.getTotalPrice()).isEqualTo(36640.0);
    }
}